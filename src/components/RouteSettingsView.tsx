...
export default function RouteSettingsView({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="glass-panel w-full sm:w-[400px] h-full sm:h-auto sm:max-h-[90vh] flex flex-col pointer-events-auto">
      ...
      <div className="flex items-center gap-3 pt-6 px-6 pb-4 shrink-0 border-b border-white/10 z-10 sticky top-0 bg-transparent">
        ...
        <h2 className="text-lg font-bold text-white mb-0.5">Rota Ayarları</h2>
      </div>
              ...
              {[
                ...
                return (
                  ...
                  >
                    ...
                    <span className={cn("text-[12px] font-medium text-center transition-colors", isActive ? "text-cyan-400" : "text-white/50")}>{item.id}</span>
                  </button>
                );
              })}
            </div>
