...
import { useRouteContext, type ChargingStopDto, type WeatherInfo, type RouteResultDto } from "../../contexts/RouteContext";
...
import { buildTimelineNodes, formatDuration, formatShortAddress, formatTime } from './routeResultModel';
...
export default function RouteResultPanel({
  ...
  const timelineNodes = useMemo(() => buildTimelineNodes(routeResult, routeLocations), [routeResult, routeLocations]);
