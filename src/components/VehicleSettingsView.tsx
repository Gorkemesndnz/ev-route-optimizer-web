...
export default function VehicleSettingsView({ onBack }: { onBack: () => void }) {
  ...
  return (
    <div className="glass-panel w-full sm:w-[420px] px-4 py-5 pointer-events-auto flex flex-col gap-4 relative h-[calc(100svh-4rem)] sm:h-[650px] overflow-hidden custom-scrollbar">
      ...
      <div className="flex items-center gap-3 shrink-0">
        ...
        <span className="text-xl font-bold tracking-tight text-white/90">Araç ve Sürücü Ayarları</span>
      </div>
      ...
      <div className="flex-1 overflow-y-auto pr-2 gap-8 flex flex-col custom-scrollbar pb-6">
           ...
           <div className="flex flex-col gap-5 bg-white/5 border border-white/10 rounded-2xl p-5 shadow-inner">
             ...
             <div className="flex items-center justify-between">
               <div className="flex flex-col">
                 <span className="text-white/80 font-medium text-[15px] flex items-center gap-2"><Users size={16} className="text-cyan-400"/> Kişi Sayısı</span>
                 <span className="text-[11px] text-white/40">Araçtaki yolcu sayısı</span>
               </div>
             ...
             <div className="flex items-center justify-between">
               <div className="flex flex-col">
                 <span className="text-white/80 font-medium text-[15px] flex items-center gap-2"><Weight size={16} className="text-cyan-400"/> Ek Ağırlık</span>
                 <span className="text-[11px] text-white/40">Bagaj veya yük <span className="text-cyan-400/80">(kg)</span></span>
               </div>
               <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl p-1">
                 ...
                 <input 
                   ...
                   className="w-8 bg-transparent text-center text-white font-bold text-lg focus:outline-none border-b border-transparent focus:border-cyan-400 transition-colors"
                 />
             ...
             <div className="flex items-center justify-between">
               <div className="flex flex-col">
                 <span className="text-white/80 font-medium text-[15px] flex items-center gap-2"><Thermostat size={16} className="text-cyan-400"/> Klima</span>
                 <span className="text-[11px] text-white/40">İklimlendirme durumu</span>
               </div>
             ...
             <div className="flex flex-col gap-3">
               <span className="text-white/80 font-medium text-[15px] flex items-center gap-2"><PlugZap size={16} className="text-cyan-400"/> Bağlayıcı Tipi (Plug Types)</span>
         ...
         <div className="flex flex-col gap-6">
           <h3 className="text-[13px] font-bold text-white/40 tracking-widest uppercase flex items-center gap-2">
             <CarFront size={16} /> Sürücü Ayarları
           </h3>
           ...
           <div className="flex flex-col gap-5 bg-white/5 border border-white/10 rounded-2xl p-5 shadow-inner">
             ...
             {/* Sürüş Tarzı */}
             <div className="flex flex-col gap-3">
               <span className="text-white/80 font-medium text-[15px] flex items-center gap-2">Sürüş Tarzı</span>
               <div className="grid grid-cols-3 gap-2">
                 {[
                   { id: 'eco', label: 'Eco' },
             ...
             <div className="flex items-center justify-between gap-2">
               <div className="flex flex-col">
                 <span className="text-white/80 font-medium text-[15px] flex items-center gap-2"><Gauge size={16} className="text-cyan-400"/> Maksimum Hız</span>
                 <span className="text-[11px] text-white/40">Gidilecek azami hız <span className="text-cyan-400/80">(km/h)</span></span>
               </div>
               <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl p-1">
             ...
             <div className="flex items-center justify-between gap-2">
               <div className="flex flex-col">
                 <span className="text-white/80 font-medium text-[15px] flex items-center gap-2"><Zap size={16} className="text-cyan-400"/> Ref. Tüketim</span>
                 <span className="text-[11px] text-white/40">Ortalama sarfiyat <span className="text-cyan-400/80">(kWh/100km)</span></span>
               </div>
               <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl p-1">
